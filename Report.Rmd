...
restaurants %>%
  ...
  knitr::kable()
```
The following table shows teh average star rating for the restaurants in each neighborhood. 
```{r exploring 4, include = TRUE}
restaurants %>% 
  group_by(neighborhood) %>% 
  summarize(Average_Rating = mean(stars), Standard_Deviation = sd(stars)) %>% 
...
>>>>>>> 2a4b13c019e5cbe29b435f893f144b53dfd2af4c
